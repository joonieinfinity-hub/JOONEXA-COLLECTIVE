...
const ServiceCard: React.FC<{ service: Service; index: number; onPageChange: (page: Page) => void }> = ({ service, index, onPageChange }) => {
  ...
  return (
    <motion.div
      ...
      className="group p-6 md:p-10 rounded-[2.5rem] border border-accent-rose/10 bg-white/40 backdrop-blur-sm hover:bg-white/60 hover:border-accent-rose/40 hover:shadow-[0_30px_60px_-12px_rgba(232,169,169,0.15)] transition-all duration-500 cursor-pointer relative z-10"
    >
